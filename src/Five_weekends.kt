...
fun main(args: Array<String>) {
    ...
    var countInYear: Int   //  counts months in a given year with 5 weekends
    ...
    println("\nThere are ${yearsWithNone.size} years with no months which have 5 weekends, namely:")
